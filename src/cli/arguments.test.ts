...
describe("CLI Arguments", () => {
        ...
        input: {
          config: {
            correct: {
              ...
              "importGraph.dependencyDepth": undefined,
              "importGraph.enabled": undefined,
              "importGraph.entryPoints": undefined,
              "importGraph.mode": undefined,
  ...
  it("should parse correct mode arguments", () => {
